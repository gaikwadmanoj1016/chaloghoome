...
export class CommonService {
  ...
  wonders: any[] = [
    ...
    { id: 5, name: "Chichen Itza", imageUrl: 'assets/imgs/wonders/chichen-itza.jpg', location: 'Chichen Itza', address: 'Mexico', description: 'Chichen Itza was a large pre-Columbian city built by the Maya people of the Terminal Classic period. The archaeological site is located in Tinúm Municipality, Yucatán State, Mexico.' },
    ...
    { id: 12, name: "Parthenon", imageUrl: 'assets/imgs/wonders/parthenon.jpg', location: 'Parthenon', address: 'Athens, Greece', description: 'The Parthenon is a former temple on the Athenian Acropolis, Greece, dedicated to the goddess Athena, whom the people of Athens considered their patron.' }
