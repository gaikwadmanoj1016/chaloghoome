...
export class ApiService {
  ...
  public getAllLanguages() {
    let API = 'assets/data/languages.json';
    return this.httpRequest.get(API, this.commonService.getRequestOptionArgs()).pipe(
      map((data) => {
        return data;
      }), catchError((error) => {
  ...
  // #endregion master lists

  public triggerContactUsEmail(req: any) {
    let API = environment.apiUrl + 'api/contact/message';
  ...
  // #region auth 
  public registration(req: any) {
    let API = environment.apiUrl + 'api/auth/userRegistration';
    return this.httpRequest.post(API, req, this.commonService.getRequestOptionArgs()).pipe(
      map((data) => {
        return data;
      }), catchError((error) => {
