...
@Component({
  ...
  standalone: true,
  imports: [PlaceDetailsComponent, PlaceDetailsNewComponent, SharedModule, NgClass, ReactiveFormsModule, NgFor, RouterLink],
...
sectionId?: number = 0;
  ...
  ngOnInit(): void {
    ...
    console.log(this.route.snapshot.routeConfig?.path?.includes('sections'));
